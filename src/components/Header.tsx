...
const Header = ({ openContactModal }: Props) => {
  ...
  return (
    <>
      ...
      <header className="bg-white shadow-sm py-3 px-5 sm:py-4 sm:px-6 w-[95%] sm:w-full sm:max-w-xl border border-gray-300 rounded-3xl fixed top-6 left-1/2 -translate-x-1/2 z-40">
