...
const BusinessAutomationDashboard = () => {
  return (
    <section className="h-[900px] bg-[radial-gradient(circle_at_center,_#0a1a3a_0%,_#000000_60%)] p-8 py-24 relative overflow-hidden">
      {/* Header */}
      ...
      <div className="relative max-w-7xl mx-auto h-full">
        {/* Sales - Far Left */}
        <div className="absolute left-0 top-8 w-80 bg-black/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6">
        ...
        {/* Marketing - Top center-left */}
        <div className="absolute left-85 top-0 bg-black/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6 w-72">
        ...
        <div className="absolute -right-6 top-4 bg-black/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6 w-80">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-2">
        ...
        <div className="absolute left-[50%] transform top-24 bg-black/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6 w-80">
          <div className="flex items-center space-x-2 mb-4">
        ...
        {/* Finance & Accounting - Middle right */}
        <div className="absolute right-12 top-110 bg-black/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6 w-72">
          <div className="flex items-center space-x-2 mb-4">
        ...
        {/* Analytics & Reporting - Bottom left */}
        <div className="absolute left-50 top-110 bg-black/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6 w-80">
          <div className="flex items-center space-x-2 mb-4">
          ...
          <div className="space-y-3 mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-white text-sm">Дашборды</div>
                <div className="text-gray-400 text-xs">В реальное времени</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-white text-sm">KPI метрики</div>
                <div className="text-gray-400 text-xs">Живые показатели</div>
              </div>
            </div>
          </div>
        </div>

        {/* Results Summary - Bottom center */}
        <div className="absolute left-[40%] transform bottom-50 bg-black/80 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6 w-96">
